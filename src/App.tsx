...
const VerificarMotoristaSemCodigoPage = lazy(() => import("./pages/VerificarMotoristaSemCodigoPage"));
      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<RouteFallback />}>
          <Routes>
            ...
            <Route path="/verificar-motorista" element={<VerificarMotoristaSemCodigoPage />} />
