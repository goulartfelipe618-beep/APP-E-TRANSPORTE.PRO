    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            O conteúdo abaixo é o mesmo bloco de contrato que entra no PDF de confirmação de grupo (página(s) após a confirmação, mesmo arquivo A4). Edite os textos na seção no final da página.
          </p>
        </div>
      ...
      >
        <div className="space-y-1">
          <Label htmlFor="grupos-contrato-pdf-toggle" className="text-base font-semibold text-foreground">
