      ...
      const [tRes, gRes] = await Promise.all([
        fetchAllSupabasePages((from, to) =>
          supabase
            ...
            .select(
              "id, tipo_viagem, perna_viagem, numero_reserva, status, user_id, motorista_id, categoria_veiculo, trajetos, ida_data, ida_hora, volta_data, volta_hora, por_hora_data, por_hora_hora, ida_embarque, ida_desembarque, volta_embarque, volta_desembarque, por_hora_endereco_inicio, por_hora_ponto_encerramento",
            )
